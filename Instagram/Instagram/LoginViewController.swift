...
class LoginViewController: UIViewController {
    ...
    @IBAction func onSignUp(_ sender: Any) {
        ...
        let newmessage = "Welcome to Instagram, " + newUser.username! as String!
        newUser.signUpInBackground {
            (succeeded: Bool, error:Error?) -> Void in
            if succeeded {
                print("Created a user")
                let alertController = UIAlertController(title: "WELCOME", message: newmessage, preferredStyle: .alert)
